...
- [x] **T16** [Docs] Create a README.md for the project — app description, screenshots, build instructions, architecture overview. **Done when**: README.md exists with all 4 sections.
